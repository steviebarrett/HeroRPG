...
/*
GameGrid.prototype.handleInput = function (delta) {
...
GameGrid.prototype.handleInputMouse = function (delta) {
...
GameGrid.prototype.handleInputTouch = function (delta) {
	var pos, newpos;
	var rect = new Rectangle(this.worldPosition.x, this.worldPosition.y, this.columns * this.cellHeight, this.rows * this.cellWidth);
...
GameGrid.prototype.shiftRowRight = function (selectedRow) {
...
GameGrid.prototype.shiftRowLeft = function (selectedRow) {
